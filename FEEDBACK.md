...
- [x] В тех тестах, что есть, не хватает ассертов. E.g: e2e.space.test.task.TaskTest#02 todo list navigation - кажется, что проверки на стиль табика
  недостаточно
...
- [x] e2e.space.test.task.TaskTest - зачем ожидания в конце каждого теста?
